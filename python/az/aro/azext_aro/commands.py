...
def load_command_table(self, _):
    aro_sdk = CliCommandType(
        operations_tmpl='azext_aro.vendored_sdks.azure.mgmt.redhatopenshift.v2023_06_10_preview.operations#OpenShiftClustersOperations.{}',  # pylint: disable=line-too-long
